...
#Leemos el archivo y como indetificador pasamos la calumna id del achivo
...
#En la tabla cancer.Columna diagnosisis cuenta los valores que contiene la columna 

cancer["diagnosis"].value_counts()

#%%
### sns.countplot()
#Muestre el conteo de observaciones en cada contenedor categórico usando barras.
''' Data = DataFrame, matriz o lista de matrices, opcional
Conjunto de datos para graficar. Si xy yestán ausentes, esto se 
interpreta como de forma amplia. 
De lo contrario, se espera que sea de formato largo.'''
...
'''
Estandarizar tomar una columna - su media /dividir entre la desviacion estandar (raiz de la varianza)
'''
